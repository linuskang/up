  ...
  return (
    <div className="flex min-h-svh flex-col gap-6 p-6">
      ...
      >
        <TabsList
          variant="line"
          className="h-fit w-48 shrink-0 flex-col items-start gap-1"
        >
          <TabsTrigger
            value="profile"
          ...
          <TabsTrigger
            value="danger"
            className="w-full justify-start gap-2 px-3 py-2 text-destructive data-active:text-destructive"
          >
        ...
        <div className="min-w-0 flex-1">
                  ...
                  <Field>
                    <FieldGroup>
                      ...
                      <Input
                        ...
                        className="h-10 border-0 !text-sm text-base"
                      />
                    </FieldGroup>
                  </Field>
                  <Field>
                  ...
                  <Field>
                    <FieldGroup>
                      ...
                      <Input
                        ...
                        disabled
                        className="h-10 border-0 !text-sm text-base opacity-50"
                      />
                    </FieldGroup>
                  </Field>
                  <Field>
          ...
          <TabsContent value="danger" className="mt-0">
            <Card className="border-destructive/20 bg-card ring-0">
              <CardHeader className="pb-2">
