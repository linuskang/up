...
function Input({
    ...
    return (
        <input
            ...
            data-slot="input"
            className={cn(
                "h-7 w-full min-w-0 rounded-md border border-border bg-input/20 px-2 py-0.5 text-sm outline-none",
                ...
                "md:text-xs/relaxed",
                "dark:bg-input/30 dark:aria-invalid:focus-visible:ring-destructive/60",
                className
            )}
            {...props}
        />
