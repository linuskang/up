                    ...
                    <form className="flex flex-col gap-5 min-w-90" onSubmit={signUp}>
                        <Field>
                            <Button
                                ...
                                onClick={github}
                                disabled={loading}
                                className="h-10 w-full text-sm justify-center gap-2 border-none cursor-pointer"
                            >
                                <Github />
                        ...
                        <Field className="-mt-2">
                            <FieldGroup>
                                ...
                                <Input
                                    ...
                                    className="ring-primary h-10 text-xl -mt-3 border-0 !text-sm"
                                />
                            </FieldGroup>
                        </Field>
                        <Field className="-mt-2">
                        ...
                        <Field>
                            <Button type="submit" disabled={loading || !agree} className="h-10 text-sm w-full cursor-pointer font-bold">
